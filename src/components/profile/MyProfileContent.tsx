    ...
    <div className="w-full border border-slate-300 dark:border-white/10 bg-white dark:bg-black/50 p-2 md:px-4 md:py-10 shadow-2xl shadow-black/30 backdrop-blur-xl transition duration-300 rounded-3xl">
      <div className="flex flex-col items-center gap-4">
        <div className="flex flex-col items-center gap-6 w-full">
          ...
          <div className="flex flex-col gap-4 items-center justify-start w-full p-5">
            {user.avatarUrl ? (
              <img
                src={user.avatarUrl}
          ...
          <div className="flex w-full justify-between items-center gap-4 px-5">
            <button className="ml-2 rounded-md px-5 md:px-16 py-2 border border-slate-300 dark:border-white/10 bg-slate-100 dark:bg-white/4 text-sm font-medium hover:bg-slate-200 hover:dark:bg-slate-900">
              Edit profile
            </button>
            <button className="ml-2 rounded-md px-5 md:px-16 py-2 border border-slate-300 dark:border-white/10 bg-slate-100 dark:bg-white/4 text-sm font-medium hover:bg-slate-200 hover:dark:bg-slate-900">
              Share profile
          ...
          <div className="w-full">
            <div className=" flex justify-between items-center px-5">
              <div className="flex flex-col sm:flex-row gap-2 text-center">
                ...
                <div className="text-zinc-700 dark:text-zinc-400 mt-1">Posts</div>
              </div>
              <div onClick={() => { setShowFollowers(true) }} className="flex flex-col sm:flex-row gap-2 text-center hover:cursor-pointer hover:bg-slate-100 dark:hover:bg-white/5 rounded-md p-3">
                <div className="text-xl font-semibold">{user.followerCount}</div>
                <div className="text-zinc-700 dark:text-zinc-400 mt-1">Followers</div>
              </div>
              <div onClick={() => { setShowFollowing(true) }} className="flex flex-col sm:flex-row gap-2 text-center hover:cursor-pointer hover:bg-slate-100 dark:hover:bg-white/5 rounded-md p-3">
                <div className="text-xl font-semibold">{user.followingCount}</div>
                <div className="text-zinc-700 dark:text-zinc-400 mt-1">Following</div>
              </div>
            </div>
          </div>
        </div>
